        ...
        <table className="table table-hover">
          ...
          <tbody>
            {displayInvestments.length === 0 ? (
              <tr><td colSpan={isSuperAdmin ? 6 : 5} style={{ padding: "2rem", textAlign: "center", color: "#cbd5e1" }}>Chưa có hạng mục đầu tư nào.</td></tr>
            ) : (
                  ...
                  {isSuperAdmin && (
                    <td style={{ textAlign: "right" }}>
                      <div style={{ display: "flex", gap: "0.5rem", justifyContent: "flex-end", alignItems: "center" }}>
                        <Link href={`/admin/investments/${item.id}/edit?page=${page}`} className="btn btn-secondary" style={{ fontSize: "0.8rem", padding: "0.35rem 0.75rem" }}>
                          Sửa
                        </Link>
