  ...
  return (
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      ...
      <div className="screen-only">
        ...
        {/* Summary Footer */}
        <div className="card" style={{ padding: "1rem 1.5rem", marginBottom: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center", background: "linear-gradient(135deg, rgba(56, 189, 248, 0.05), rgba(129, 140, 248, 0.05))", borderTop: "1px solid rgba(56, 189, 248, 0.15)" }}>
