...
export default function ProposalRowActions({ 
  ...
  return (
    <div ref={popoverRef} style={{ display: "flex", gap: "0.5rem", justifyContent: "flex-end", alignItems: "center", position: "relative" }}>
      {/* SLOT 1: Nút Xem (Cố định vị trí 100%) */}
      ...
      {/* SLOT 2: Nút Xuất BBBG (Chỉ dành riêng cho Super Admin khi hoàn thành) */}
      ...
      {/* SLOT 3: Nút Xóa Dự Trù dành riêng cho SAdmin (Cố định vị trí 100%) */}
      <div style={{ width: "64px", flexShrink: 0, position: "relative" }}>
        {isSuperAdmin ? (
          <>
            ...
            {/* Popover Xóa Quay lên Trên (Smart Top Positioned Popover) */}
            {showConfirm && (
              <div style={{
                position: "absolute",
                bottom: "calc(100% + 8px)",
